      ...
      <div>
        <Collapsible popout>
          ...
          <CollapsibleItem header='Convert $'>
            Use the 'Convert $' form to compare the rates between any two currencies. Select a 'base currency' and 'comparator currency' using the autocomplete form and clicking on one of the listed items.
            The form will default to a rate of 1 for the base. You can modify either the base or comparator currency or rates thereof for immediate updates.
          </CollapsibleItem>
